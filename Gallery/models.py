...
class WeeklyDarshan(models.Model):
    id = models.AutoField(primary_key=True, auto_created=True)
    name = models.CharField(max_length=50)
    gallery_image = models.ImageField(upload_to='weeklydarshan/')
...
class Media(models.Model):
    id = models.AutoField(primary_key=True, auto_created=True)
    name = models.CharField(max_length=50)
    gallery_image = models.ImageField(upload_to='gallerymedia/')
...
class FestivalDarshan(models.Model):
    id = models.AutoField(primary_key=True, auto_created=True)
    name = models.CharField(max_length=50)
    gallery_image = models.ImageField(upload_to='festivaldarshan/')
